...
onesim <- function(n) {
  ...
  data <- as.data.frame(sim.CATE(n, randomized = T))
  ...
  CATE_library <- list(   Lrnr_ranger$new(max.depth = 7),  Lrnr_ranger$new(max.depth = 10), Lrnr_earth$new(), Lrnr_xgboost$new(max_depth = 3, verbosity = 0), Lrnr_xgboost$new(max_depth = 5, verbosity = 0),   Lrnr_xgboost$new(max_depth = 7, verbosity = 0), Lrnr_rpart$new(), lrnr_gam3, lrnr_gam5, Lrnr_glm$new()    )
...
#save(simresults500, file = paste0("simsCATE_Randomized", hard,pos, "n500_3"))
...
#save(simresults1000, file = paste0("simsCATE_Randomized", hard,pos, "n1000_3"))
...
#save(simresults2500, file = paste0("simsCATE_Randomized", hard,pos, "n2500_3"))
...
save(simresults5000, file = paste0("simsCATE_Randomized", hard,pos, "n5000_3"))
...
save(simresults10000, file = paste0("simsCATE_Randomized",  "n10000_3"))
