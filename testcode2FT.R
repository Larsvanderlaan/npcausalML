...
CATE_library <- list(Lrnr_earth$new(), Lrnr_xgboost$new(max_depth = 3, verbosity = 0), Lrnr_xgboost$new(max_depth = 5, verbosity = 0), Lrnr_ranger$new(), Lrnr_rpart$new(), lrnr_gam3 , lrnr_gam5, Lrnr_glm$new()    )
...
save(simresults, file = "simsCATEFTn1000")
...
save(simresults, file = "simsCATEFTn2500")
...
save(simresults, file = "simsCATEFTn5000")
...
save(simresults, file = "simsCATEFTn10000")
