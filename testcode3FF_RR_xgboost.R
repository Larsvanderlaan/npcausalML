...
save(simresults250, file = paste0("mainSimResults/","simsLRR_xgboost_", hard,pos, "n250_3"))
...
save(simresults500, file = paste0("mainSimResults/","simsLRR_xgboost_", hard,pos, "n500_3"))
...
save(simresults1000, file = paste0("mainSimResults/","simsLRR_xgboost_", hard,pos, "n1000_3"))
...
save(simresults2500, file = paste0("mainSimResults/","simsLRR_xgboost_", hard,pos, "n2500_3"))
