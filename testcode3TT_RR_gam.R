...
save(simresults500, file = paste0("mainSimResults/","simsLRR_GAM_", hard,pos, "n250_3"))
...
save(simresults1000, file = paste0("mainSimResults/","simsLRR_GAM_", hard,pos, "n500_3"))
...
save(simresults2500, file = paste0("mainSimResults/","simsLRR_GAM_", hard,pos, "n1000_3"))
...
save(simresults5000, file = paste0("mainSimResults/","simsLRR_GAM_", hard,pos, "n2500_3"))
...
save(simresults10000, file = paste0("mainSimResults/","simsLRR_GAM_", hard,pos, paste0("n5000")))
