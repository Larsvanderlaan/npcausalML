...
onesim <- function(n) {
  ...
  CATE_library <- list( Lrnr_xgboost$new(max_depth = 1, verbosity = 0),  Lrnr_xgboost$new(max_depth = 3, verbosity = 0), Lrnr_xgboost$new(max_depth = 5, verbosity = 0),   Lrnr_xgboost$new(max_depth = 7, verbosity = 0), Lrnr_xgboost$new(max_depth = 10, verbosity = 0), Lrnr_xgboost$new(max_depth = 15, verbosity = 0), Lrnr_xgboost$new(nrounds = 50, max_depth = 20, verbosity = 0)  )
...
save(simresults500, file = paste0("mainSimResults", "simsCATE", hard,pos, "n500_overfitting"))
...
save(simresults1000, file = paste0("mainSimResults", "simsCATE", hard,pos, "n1000_overfitting"))
...
save(simresults2500, file = paste0("mainSimResults", "simsCATE", hard,pos, "n2500_overfitting"))
...
save(simresults5000, file = paste0("mainSimResults", "simsCATE", hard,pos, "n5000_overfitting"))
...
save(simresults10000, file = paste0("mainSimResults", "simsCATE", hard,pos, "n10000_overfitting"))
