#'   Selector
#'
#' This meta-learner identifies the selector (i.e. discrete
...
#'
#
Lrnr_selector <- R6Class(
  classname = "Lrnr_selector",
  inherit = Lrnr_base, portable = TRUE,
  class = TRUE,
  public = list(
    initialize = function(loss_function,
                          ...) {
      params <- args_to_list()
  ...
  private = list(
    ...
    .train = function(task) {
      ...
      risk <- function(preds) {
        loss <- loss_function(preds, Y, task$row_index)
