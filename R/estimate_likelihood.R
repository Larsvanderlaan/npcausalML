...
estimate_initial_likelihood <- function(W, A, Y, weights = NULL, sl3_Learner_pA1W, sl3_Learner_EYAW, folds = 10, outcome_type = NULL) {
  ...
  tryCatch({EY1W_full <- sl3_Learner_EYAW_trained$predict_fold(task_EY1W, "full")
  EY0W_full <- sl3_Learner_EYAW_trained$predict_fold(task_EY0W, "full")}, error = function(cond){})
...
#  }
  ...
  internal <-  list(task_pA1W = task_pA1W, task_EY = task_EY, task_EY1W = task_EY1W, task_EY0W = task_EY0W, sl3_Learner_pA1W_trained = sl3_Learner_pA1W_trained, sl3_Learner_EYAW_trained = sl3_Learner_EYAW_trained, folds = folds)
