...
CATE_library <- list(Lrnr_xgboost$new(nround = 1,
                                      subsample = 0.8,
                                      colsample_bytree = 0.5,
                                      num_parallel_tree = 500,
                                      max_depth = 8, verbosity = 0), Lrnr_earth$new(), Lrnr_xgboost$new(max_depth = 3, verbosity = 0), Lrnr_xgboost$new(max_depth = 5, verbosity = 0),   Lrnr_rpart$new(), lrnr_gam3 , lrnr_gam5, Lrnr_glm$new()    )
...
save(simresults, file = "simsCATEFFn500")
