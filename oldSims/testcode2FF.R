...
#
# print(500)
# simresults500 <- lapply(1:20, function(i){
#   print(i)
#   onesim(500)
# })
#
# save(simresults500, file = paste0("simsCATE", hard,pos, "n500_2"))
#
#
# print(1000)
# simresults1000 <- lapply(1:20, function(i){
#   print(i)
#   onesim(1000)
# })
#
# save(simresults1000, file = paste0("simsCATE", hard,pos, "n1000_2"))

print(2500)
simresults2500 <- lapply(1:20, function(i){
  print(i)
  onesim(2500)
})

save(simresults2500, file = paste0("simsCATE", hard,pos, "n2500_2"))

print(5000)
simresults5000 <- lapply(1:20, function(i){
  print(i)
  onesim(5000)
})

save(simresults5000, file = paste0("simsCATE", hard,pos, "n5000_2"))


print(10000)
simresults10000 <- lapply(1:20, function(i){
  print(i)
  onesim(10000)
})

save(simresults10000, file = paste0("simsCATE", hard,pos, "n10000_2"))
